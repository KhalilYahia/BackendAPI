...
namespace YaznGhanem.Services.services
{
    public class OtherSalesService : IOtherSalesService
    {
        ...
        private async Task<bool> AddMoneytoFund(decimal money)
        {
            ...
            var existingTotalFunds = (await _unitOfWork.repository<TotalFunds>().GetAllAsync()).FirstOrDefault();
            ...
            _unitOfWork.repository<TotalFunds>().UpdateAsync(existingTotalFunds);
